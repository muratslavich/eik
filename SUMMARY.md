...
* [Kafka](tools/kafka/README.md)
  * [Kafka scheme](tools/kafka/kafka-scheme.md)
  * [Delete topic](tools/kafka/delete-topic.md)
  * [Kafka cluster migration algorithm](tools/kafka/kafka-cluster-migration-algorithm/README.md)
    * [Kafka cluster migration](tools/kafka/kafka-cluster-migration-algorithm/kafka-cluster-migration.md)
    * [Kafka reassignment](tools/kafka/kafka-cluster-migration-algorithm/kafka-reassignment.md)
    * [Zookeeper cluster migration](tools/kafka/kafka-cluster-migration-algorithm/zookeeper-cluster-migration.md)
  * [zkCLi commands](tools/kafka/zkcli-commands.md)
  * [cp-kafka shell scripts](tools/kafka/cp-kafka-shell-scripts.md)
  * [Kafka configurations](tools/kafka/kafka-configurations.md)
  * [Kafka cluster 3+3 conduktor](tools/kafka/kafka-cluster-3+3-conduktor.md)
  * [Zookeeper folders](tools/kafka/zookeeper-folders.md)
  * [Zookeeper docker container](tools/kafka/zookeeper-docker-container.md)
  * [Kafka Visualization](tools/kafka/kafka-visualization.md)
  * [Zookeeper cluster status check](tools/kafka/zookeeper-cluster-status-check.md)
  * [Kafka overview](tools/kafka/kafka-overview.md)
  * [Kafka consumer](tools/kafka/kafka-consumer.md)
  * [Kafka producer](tools/kafka/kafka-producer.md)
  * [Kafka use-cases](tools/kafka/kafka-use-cases.md)
  * [Kafka Visualization](tools/kafka/kafka-visualization-1.md)
